...
<div class="navbar navbar-default" role="navigation">
		...
		<div class="navbar-header">
			...
			<a href="{{ url('dashboard') }}" class="navbar-brand smoothScroll">
		...
		<div class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
                ...
                @elseif(Session::get('login_id') AND (Session::get('user_type') == 'freelancer'))

                	<li class="login">
                        <a href="{{ url('/profile/fl') }}/{{ Session::get('login_id') }}" class="smoothScroll" 
                    >MY PROFILE
                    </a>
